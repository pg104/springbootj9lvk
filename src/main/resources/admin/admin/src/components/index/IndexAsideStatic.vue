      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          el.addEventListener("mouseenter", e => {
            e.stopPropagation()
            el.style.backgroundColor = "rgba(204, 204, 204, 0.61)"
          })
          el.addEventListener("mouseleave", e => {
            e.stopPropagation()
            // el.style.backgroundColor = " linear-gradient(90deg, rgba(232,229,229,1) 0%, rgba(235,235,235,1) 70%, rgba(48,43,43,0.819765406162465) 100%)"
...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		background: linear-gradient(90deg, rgba(255,255,255,1) 45%, rgba(122,131,140,1) 100%) !important;
		...
		&>.el-menu-item {
			...
			border-style: solid;
			border-color: rgba(54, 53, 53, 1) !important;
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			.el-menu-item {
                ...
                &.is-active {
                    ...
                    background-color: rgba(130, 138, 147, 1) !important;
                    box-shadow: 0 0 6px rgba(30, 144, 255, 0);
                    text-align: center;
                }
